<template>
  <div class="about">
    <el-card class="box-card">
      <div class="top">
        <div class="left"><el-alert title="本月：社保在缴 公积金在缴  增员  减员  入职  离职" type="info" show-icon  :closable="false"/></div>
        <div class="right">
          <div @click="$router.push('/home/history')">历史归档</div>
          <div @click="$router.push('/home/state')">202001月报表</div>
        </div>
      </div>
      <div class="flex">
    ...
    <el-card class="box-card">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column  label="离职时间" sortable >---</el-table-column>
