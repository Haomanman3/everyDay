<template>
  <div>
    ...
    <el-card class="box-card">
      <el-table :data="$store.state.check.checkData" style="width: 100%" height="350">
...
export default {
  ...
  methods: {
    tableList(params) {
     this.$store.dispatch("check/checks",params)
    },
    pigeonhole() {
      this.$router.push("/about/checkHistory")
    },
    statement() {
      this.$router.push("/about/menstruation")
    },
    lead() {
      this.$router.push("/about/checkimg")
    }
  },
  mounted() {},
  watch: {}
