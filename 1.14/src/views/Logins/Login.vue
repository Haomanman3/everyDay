<template>
  <div class="login">
    <div class="box">
      ...
      <h3 style="text-align: center">账号：13800000002 密码：123456</h3>
      <p>
        <a href="https://shuiruohanyu.gitee.io/yyds/document/" class="yellow">学习文档</a>
      </p>
    </div>
  </div>
</template>
